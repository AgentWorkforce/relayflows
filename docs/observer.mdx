...
Every workflow run that uses a broker prints a link you can open to follow it in
real time — messages, agent activity, handoffs, and deliveries as they happen.
...
Open the `Observer:` URL, or paste it to a teammate. It carries a scoped
